...
2.times do
  User.create(wechat_name: Faker::DumbAndDumber.actor, open_id: Faker::IDNumber.invalid, description: Faker::DumbAndDumber.quote, avatarUrl: Faker::DumbAndDumber.quote)
end
